...
use crate::parser::syntax_fragments::{
    derive_traits::*,
    fragment_generators::{
        end_iter_fn, gen_enum_fn_iter_start, gen_enum_fn_variant_names, gen_enum_match_arm, gen_enum_start,
        gen_enum_variant, gen_fq_enum_variant, gen_impl_start, gen_type_name,
    },
    *,
};
...
impl EntityContainer {
    ...
    pub fn to_enum_with_impl(&self) -> Vec<u8> {
        ...
        //       match *self {↩︎
        let mut enum_fn_variant_name = FN_VARIANT_NAME_START.to_vec();
        ...
        enum_fn_variant_name.append(&mut [END_BLOCK, END_BLOCK].concat());

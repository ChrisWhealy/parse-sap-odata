...
impl EntityContainer {
    ...
    pub fn to_enum_with_impl_into(&self, out: &mut String) {
        ...
        gen_enum_fn_iter_start(&mut enum_fn_iterator, &cont_name_camel);
        gen_enum_impl_fn_variant_name(&mut enum_fn_variant_name);
        ...
        entities_enum.push_str(&gen_enum_start_src(&cont_name_camel));
        ...
        gen_end_iter_fn(&mut enum_fn_iterator);
        ...
        gen_impl_start_for(out, &cont_name_camel);
        out.push_str(&enum_fn_iterator);
        out.push_str(&enum_fn_variant_name);
        gen_enum_fn_variant_names(out, &cont_name_camel);
    ...
    pub fn to_enum_with_impl(&self) -> String {
        ...
        entities_enum.push_str(&gen_derive_str(&[DeriveTraits::COPY, DeriveTraits::CLONE, DeriveTraits::DEBUG]));
        entities_enum.push_str(RUSTC_ALLOW_DEAD_CODE);
        gen_enum_start(&mut entities_enum, &cont_name_camel);
        ...
        out.push_str(RUSTC_ALLOW_DEAD_CODE);
        gen_impl_start_for(&mut out, &cont_name_camel);
        out.push_str(&enum_fn_iterator);
        out.push_str(&enum_fn_variant_name);
        gen_enum_fn_variant_names(&mut out, &cont_name_camel);
        out.push_str(END_BLOCK);

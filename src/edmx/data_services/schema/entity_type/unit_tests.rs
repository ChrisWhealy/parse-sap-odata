...
use crate::{property::edm_type::EdmType, test_utils::*};
...
pub fn should_parse_entity_type_business_partner() -> Result<(), String> {
    ...
    match String::from_utf8(xml_buffer) {
        Ok(xml) => {
            ...
            handle_test_comparison(&ent_type.properties[0].edm_type, &EdmType::Complex("CtAddress".to_owned()))?;
            ...
            handle_test_comparison(&ent_type.properties[1].edm_type, &EdmType::from("Edm.String"))?;
...
pub fn should_parse_entity_type_product() -> Result<(), String> {
    ...
    match String::from_utf8(xml_buffer) {
        Ok(xml) => {
            ...
            handle_test_comparison(&property_price.edm_type, &EdmType::from("Edm.Decimal"))?;
            ...
            handle_test_comparison(&property_changed_at.edm_type, &EdmType::from("Edm.DateTime"))?;
...
pub fn should_parse_entity_type_groups() -> Result<(), String> {
    ...
    match String::from_utf8(xml_buffer) {
        Ok(xml) => {
            ...
            handle_test_comparison(&group_id_prop.edm_type, &EdmType::from("Edm.String"))?;

...
In the metadata module, `Property.edm_type` used to be of type `String` which had the consequence that the same `String` value was being repeatedly created such as `Edm.String`, `Edm.Decimal` or `Edm.DateTime`.
